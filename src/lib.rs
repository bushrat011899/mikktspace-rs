...
//!
//! ```
//! # use mikktspace_rs::{MikkTSpaceInterface, Ops};
//! # struct MyOps;
//! # struct MyGeometry;
//! impl Ops for MyOps {
//!     fn sqrt(x: f32) -> f32 {
...
//!
//! # #[cfg(any())]
//! impl MikkTSpaceInterface<MyOps> for MyGeometry { /* ... */ }
//! ```
//!
//! A common backend for implementing [`Ops`] is [`libm`]:
//!
//! ```
//! # use mikktspace_rs::Ops;
//! # struct LibmOps;
...
/// threshold disabled.
pub fn generate_tangent_space<I, O>(interface: &mut I) -> Result<(), GenerateTangentSpaceError>
where
    I: MikkTSpaceInterface<O>,
    O: Ops,
{
    generate_tangent_space_with_threshold(interface, -1_f32)
}
...
pub fn generate_tangent_space_with_threshold<I, O>(
    interface: &mut I,
    threshold: f32,
...
>
{
    ...
    fn set_tangent_space(&mut self, tangent_space: Option<TangentSpace>, face: usize, vert: usize);
}
